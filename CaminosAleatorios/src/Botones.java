...
public class Botones extends JPanel{
	...
	/**
	 * Constructor que instancia todos los componentes.
	 */
	public Botones(){
	...
	/**
	 * Método que da los valores al Spinner.
	 */
	void iniciarSpinner(){
	...
	/**
	 * Metodo que actualiza la etiqueta de color actual con el color con el que se está pintando el camino.
	 * @param color
	 */
